...
const submitDir = 'C:/Users/Bixbie/Documents/event/bl4cksite/app/innovation-lab/submit';
...
'}',
'',
'const inputCls = "w-full bg-white/[0.04] border border-white/10 rounded-xl px-4 py-3 text-white text-sm font-mono outline-none focus:border-[#00F5FF]/50 transition-colors";',
'',
...
fs.writeFileSync(path.join(submitDir, 'page.tsx'), content);
console.log('Done! Created:', path.join(submitDir, 'page.tsx'));
...
const filePath = path.join(dir1, 'page.tsx');
fs.writeFileSync(filePath, pageContent);
console.log('✓ File created: page.tsx');

console.log('\n✅ SUCCESS: All directories and files created!');
console.log('  1. Directory: c:\\Users\\Bixbie\\Documents\\event\\bl4cksite\\app\\innovation-lab\\submit');
console.log('  2. Directory: c:\\Users\\Bixbie\\Documents\\event\\bl4cksite\\app\\build-with-us-DELETE');
console.log('  3. File: page.tsx');
