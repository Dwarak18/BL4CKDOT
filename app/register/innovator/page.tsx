  ...
  return (
    <div className="min-h-screen py-16 px-4 relative animate-slide-up">
      ...
      <div className="max-w-2xl mx-auto">
        {/* Back link */}
        <Link href="/" className="inline-flex items-center gap-2 text-white/40 hover:text-neon-purple text-xs font-mono tracking-widest uppercase mb-8 transition-colors">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold text-white mt-3">Submit Your Innovation</h1>
          <p className="text-white/40 text-sm max-w-lg mx-auto mt-2 leading-relaxed">
            Creators &amp; Visionaries — Build what matters.
          </p>
        </div>
